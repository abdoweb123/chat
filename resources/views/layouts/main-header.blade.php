 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <div class="text-center" style="background-color:#f9f9f94f">
                    <a class="navbar-brand brand-logo p-0" href="index.html"><img src="" style="width:80px; height:66px;" alt=""></a>
                </div>
                ...
                <li class="nav-item dropdown mr-30">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <form action="{{route('logout')}}" method="post">
                            @csrf
                            <button type="submit" class="dropdown-item"><i class="text-info"></i>Logout</button>
                        </form>
                    </div>
                </li>
            </ul>
